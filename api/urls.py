...
from .views import add_product,delete, get_product,get_products,get_by_name,get_color,get_date,get_price,get_endWith,get_brend,do_updates,get_by_brend_all
urlpatterns = [
    ...
    path("<str:pk>/all",get_by_brend_all)
]